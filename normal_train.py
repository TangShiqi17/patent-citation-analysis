...
parser.add_argument('--batch-size', default=200, type=int, metavar='N',
                    help='train batchsize')
parser.add_argument('--batch-size-u', default=200, type=int, metavar='N',
                    help='train batchsize')
...
def main():
    ...
    train_labeled_set, val_set, test_set, n_labels = get_data(
        r'C:\Users\ADMIN\Desktop\classify',3000)
    #train_labeled_set, train_unlabeled_set, val_set, test_set, n_labels = get_data(
    labeled_trainloader = Data.DataLoader(
        dataset=train_labeled_set, batch_size=16, shuffle=True)
    val_loader = Data.DataLoader(
        dataset=val_set, batch_size=16, shuffle=False)
    ...
    for epoch in range(35):
        ...
        if val_acc > 0.9:
            best_acc = val_acc
            torch.save(model.state_dict(), 'ns.pt')
            break
...
if __name__ == '__main__':
    main()
'python normal_train.py --gpu 0 --n-labeled 3000 --data-path /data/ --batch-size 8 --epochs 20'